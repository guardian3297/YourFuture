...
export const defaultProfile: ProfileInput = {
  ...
  goals: ["crescimento profissional", "produto", "pensamento sistemico"],
  interests: ["IA", "cinema", "filosofia", "design", "jogos narrativos"],
  routine: "Manha com planejamento, tarde para criacao profunda e noite para leitura ou conteudo imersivo.",
  freeText: "Quero entender melhor meus padroes, escolher melhor o que consumo e evoluir de forma consistente.",
  answers: [
    { questionId: "q1", value: 92, tags: ["estrategia", "sistemas", "clareza"] },
    { questionId: "q2", value: 86, tags: ["foco", "profundidade"] },
    { questionId: "q3", value: 94, tags: ["futuro", "filosofia", "visao"] },
    { questionId: "q4", value: 90, tags: ["lideranca", "estrategia"] },
    { questionId: "q5", value: 90, tags: ["projeto", "aprendizado_ativo"] },
    { questionId: "q6", value: 62, tags: ["perfeccionismo", "atrito"] }
  ]
};
